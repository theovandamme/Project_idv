(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.rendervous = {}));
  ...
  const tauEpsilon$1 = tau$1 - epsilon$1;
  ...
  function ellipse (pathGen, x, y, rx, ry, rot, a0, a1, ccw) {
    ...
    if (pathGen._x1 === null) {
      // Is this path empty? Move to (x0,y0).
      pathGen._ += 'M' + x0 + ',' + y0;
    } else if (Math.abs(pathGen._x1 - x0) > epsilon$1 || Math.abs(pathGen._y1 - y0) > epsilon$1) {
      // Or, is (x0,y0) not coincident with the previous point? Line to (x0,y0).
      pathGen._ += 'L' + x0 + ',' + y0;
    }
    ...
    if (da > tauEpsilon$1) {
      ...
      // Is this arc non-empty? Draw an arc!
      pathGen._ += 'A' + rx + ',' + ry + ',0,' + (+(da >= pi$1)) + ',' + cw + ',' + (pathGen._x1 = x + rx * Math.cos(a1)) + ',' + (pathGen._y1 = y + ry * Math.sin(a1));
    }
  }
  ...
  class Path$2 extends BasePath$1 {
    result () {
  ...
  function parseAesthetics$2 (props, parsedProps) {
    ...
    parsedProps.curve = fallback(props.curve, curveLinear);
    return parseAesthetics$1(props, parsedProps)
  }
  ...
  ***************************************************************************** */
  ...
  function createPipeline$2 (props, section, scales, context, outputSettings) {
    return chain(
      ...
      outputSettings.round ? round(outputSettings.decimals) : null,
      section.coordinateSystem ? null : curveLinear$1,
      context
    )
  }
  ...
  function createScale$1 (c, r) {
    return linear$1().domain([0, 1]).range([c, r + c])
  }
  ...
  exports.bboxLabel = bboxLabel;
  exports.bboxLabelLayer = bboxLabelLayer;
  exports.bboxLine = bboxLine;
  exports.bboxLineLayer = bboxLineLayer;
  exports.bboxPoint = bboxPoint;
  exports.bboxPointLayer = bboxPointLayer;
  exports.bboxPolygon = bboxPolygon;
  exports.bboxPolygonLayer = bboxPolygonLayer;
  exports.bboxToClipArgs = bboxToClipArgs;
  exports.bboxToClipRect = bboxToClipRect;
  exports.calculateLinearRingCentroidAndArea = calculateLinearRingCentroidAndArea;
  exports.cartesian = cartesian;
  exports.centroidLabel = centroidLabel;
  exports.centroidLabelLayer = centroidLabelLayer;
  exports.centroidLine = centroidPolygon;
  exports.centroidLineLayer = centroidPolygonLayer;
  exports.centroidPoint = centroidPoint;
  exports.centroidPointLayer = centroidPointLayer;
  exports.centroidPolygon = centroidPolygon;
  exports.centroidPolygonLayer = centroidPolygonLayer;
  exports.chain = chain;
  exports.createArea = createArea;
  exports.createAreaLayer = createAreaLayer;
  exports.createFuncLine = createFuncLine;
  exports.createLabel = createLabel;
  exports.createLabelLayer = createLabelLayer;
  exports.createLine = createLine;
  exports.createLineLayer = createLineLayer;
  exports.createPoint = createPoint;
  exports.createPointLayer = createPointLayer;
  exports.createPointSection = createPointSection;
  exports.createPolygon = createPolygon;
  exports.createPolygonLayer = createPolygonLayer;
  exports.createRectangle = createRectangle;
  exports.createRectangleLayer = createRectangleLayer;
  exports.createSection = createSection;
  exports.createSymbol = createSymbol;
  exports.createSymbolLayer = createSymbolLayer;
  exports.createTransformer = createTransformer;
  exports.fitScales = fitScales;
  exports.getClipId = getClipId;
  exports.getClipPathURL = getClipPathURL;
  exports.getClipType = getClipType;
  exports.getGridCells = getGridCells;
  exports.parseAestheticsArea = parseAestheticsArea;
  exports.parseAestheticsAreaLayer = parseAestheticsAreaLayer;
  exports.parseAestheticsFuncLine = parseAestheticsFuncLine;
  exports.parseAestheticsLabel = parseAestheticsLabel;
  exports.parseAestheticsLabelLayer = parseAestheticsLabelLayer;
  exports.parseAestheticsLine = parseAestheticsLine;
  exports.parseAestheticsLineLayer = parseAestheticsLineLayer;
  exports.parseAestheticsPoint = parseAestheticsPoint;
  exports.parseAestheticsPointLayer = parseAestheticsPointLayer;
  exports.parseAestheticsPolygon = parseAestheticsPolygon;
  exports.parseAestheticsPolygonLayer = parseAestheticsPolygonLayer;
  exports.parseAestheticsRectangle = parseAestheticsRectangle;
  exports.parseAestheticsRectangleLayer = parseAestheticsRectangleLayer;
  exports.parseAestheticsSymbol = parseAestheticsSymbol;
  exports.parseAestheticsSymbolLayer = parseAestheticsSymbolLayer;
  exports.parsePositioningArea = parsePositioningArea;
  exports.parsePositioningAreaLayer = parsePositioningAreaLayer;
  exports.parsePositioningFuncLine = parsePositioningFuncLine;
  exports.parsePositioningLabel = parsePositioningLabel;
  exports.parsePositioningLabelLayer = parsePositioningLabelLayer;
  exports.parsePositioningLine = parsePositioningLine;
  exports.parsePositioningLineLayer = parsePositioningLineLayer;
  exports.parsePositioningPoint = parsePositioningPoint;
  exports.parsePositioningPointLayer = parsePositioningPointLayer;
  exports.parsePositioningPolygon = parsePositioningPolygon;
  exports.parsePositioningPolygonLayer = parsePositioningPolygonLayer;
  exports.parsePositioningRectangle = parsePositioningRectangle;
  exports.parsePositioningRectangleLayer = parsePositioningRectangleLayer;
  exports.parsePositioningSymbol = parsePositioningSymbol;
  exports.parsePositioningSymbolLayer = parsePositioningSymbolLayer;
  exports.polar = polar;
  exports.recorderLabel = recorderLabel;
  exports.recorderLabelLayer = recorderLabelLayer;
  exports.recorderLayer = recorderLayer;
  exports.recorderMark = recorderMark;
  exports.round = round;
  exports.scale = scale;
  exports.split = split;
  exports.streamArea = streamArea;
  exports.streamAreaLayer = streamAreaLayer;
  exports.streamGeometries = streamGeometries;
  exports.streamGeometry = streamGeometry;
  exports.streamLine = streamLine;
  exports.streamLineLayer = streamLineLayer;
  exports.streamPoint = streamPoint;
  exports.streamPointLayer = streamPointLayer;
  exports.streamPolygon = streamPolygon;
  exports.streamPolygonLayer = streamPolygonLayer;
  exports.streamRectangle = streamRectangle;
  exports.streamRectangleLayer = streamRectangleLayer;
  exports.svgPositioning = svgPositioning;
  exports.svgStyled = svgStyled;
  exports.transform = transform;
  exports.validateArea = validateArea;
  exports.validateAreaLayer = validateAreaLayer;
  exports.validateFuncLine = validateFuncLine;
  exports.validateLabel = validateLabel;
  exports.validateLabelLayer = validateLabelLayer;
  exports.validateLine = validateLine;
  exports.validateLineLayer = validateLineLayer;
  exports.validatePoint = validatePoint;
  exports.validatePointLayer = validatePointLayer;
  exports.validatePolygon = validatePolygon;
  exports.validatePolygonLayer = validatePolygonLayer;
  exports.validateRectangle = validateRectangle;
  exports.validateRectangleLayer = validateRectangleLayer;
  exports.validateSymbol = validateSymbol;
  exports.validateSymbolLayer = validateSymbolLayer;
  exports.x2 = x2;
  exports.x2s = x2s;
  exports.y2 = y2;
  exports.y2s = y2s;
